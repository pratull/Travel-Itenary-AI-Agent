...
class TravelTasks:
    ...
    def plan_itinerary(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            agent=agent,
            expected_output="A complete 7-day itinerary with detailed day-wise plans, restaurant and hotel recommendations, and travel logistics."
        )
    ...
    def identify_city(self, agent, origin, cities, interests, travel_dates):
        ...
        """
            ...
            agent=agent,
            expected_output="A detailed report on the best city choice, including flight costs, weather forecast, and attractions."
    ...
    def gather_city_info(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            agent=agent,
            expected_output="A detailed city guide with must-visit places, cultural hotspots, hidden gems, weather forecasts, and cost breakdowns."
        )
